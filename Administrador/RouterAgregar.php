                                    ...
                                    <form id="AgregarRouter">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control"  name="Nombre" placeholder="Ej: RB Zona" type="text" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">IP<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="IP" placeholder="Ej: 192.168.1.1" type="text" /></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Usuario del RB<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" name="Usuario" placeholder="Ej: Admin" type="text" /></div>
                                        </div>
                                        <div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Password del RB<span class="required">*</span></label>
											<div class="col-md-6 col-sm-6">
												<input class="form-control" type="password" id="password1" name="PWD" placeholder="Ej: 1234567" />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" class='number' name="PuertoAPI" value="8728"></div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <textarea  name='RangoIP' placeholder="Ej: 192.168.1.0"></textarea></div>
                                        </div>
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    <button type='button' class="btn btn-primary" id="" onclick='AgregaRouter()'>Guardar</button>
                                                    <button type='button' class="btn btn-success" >Guardar y Comprobar Conexion</button>
