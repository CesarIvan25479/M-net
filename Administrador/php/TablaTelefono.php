<?php
    ...
    $servicioTel = $_SESSION['servicioTel'];
?>
<div class="row">
	<div class="col-sm-12">
        <div class="col-md-12">
                    <h5><?php echo $servicioTel; ?> Lineas de Telefono</h5>
        </div>
        <table class="table table-sm">
            ...
            $consulta2 = "SELECT P.OBSERV ,V.NO_REFEREN, C.NOMBRE, F_EMISION, P.PRECIO, V.TIPO_DOC,
                         ...
                         partvta P ON V.VENTA=P.VENTA WHERE C.CLIENTE='$cliente' AND V.F_EMISION BETWEEN '$FechaInCl' AND '$FechaActual' AND ARTICULO='RT' AND V.TIPO_DOC!='PE' order by V.F_EMISION  asc";
